...
export default function Footer(){
  return(
    ...
    <footer class="w-full bottom-0 bg-[#287f6f] p-8">
      <div class="flex flex-row flex-wrap items-center justify-center gap-y-6 gap-x-12 bg-[#287f6f] text-center md:justify-evenly">
        <p class="block antialiased font-sans text-base leading-relaxed text-inherit text-center font-normal bg-[#287f6f]">© 2023 Freebird</p>
