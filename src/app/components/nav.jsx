  ...
  return (
    <>
      <nav class=" text-[#40ccb3] flex justify-between items-center bg-[#f3f4f6]  py-4 px-8">
        ...
        <Link href="https://www.getfreebird.app/" target="_blank" rel="noopener noreferrer">
          <Image src='/public/assets/freebird.jpg' height='50' width='50' alt="Image"/></Link>
     
        <div class=" text-3xl  font-semibold md:visible sm:invisible">Pricing</div>
