...
export default function Country({country,OnChange}){
  return(
    <div class=" items-center md:ml-auto">
      <select id="country" class="  m-auto mt-4 p-1  w-[180px] rounded-[28px] border-2 border-[#40ccb3]" onChange={OnChange}>
       {country.map((item)=>
       <option class="rounded-[24px] m-auto text-black" value={item}>{item}</option>)} 
